...
drop_likes = "DROP TABLE IF EXISTS likes"
for drop in (drop_users, drop_posts, drop_comments, drop_likes):
...
"""
for table in [create_users_table, create_posts_table, create_comments_table, create_likes_table]:
...
VALUES
  ...
  (3, 6);
"""
for record in (create_users, create_posts, create_comments, create_likes):
    execute_query(connection, record)
